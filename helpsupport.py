...
# This part is image labels setting start 
    ...
    def facebook(self):
        self.new = 1
        self.url = "https://www.facebook.com/ExeWhyZ"
        webbrowser.open(self.url,new=self.new)
    
    def youtube(self):
        self.new = 1
        self.url = "https://www.youtube.com/channel/UCgIFeZ0N9cTeX0qtWV1peNA"
        webbrowser.open(self.url,new=self.new)
    
    def gmail(self):
        self.new = 1
        self.url = "mailto:araj52444+work@gmail.com?subject=Portfolio Website Contact"
        webbrowser.open(self.url,new=self.new)
